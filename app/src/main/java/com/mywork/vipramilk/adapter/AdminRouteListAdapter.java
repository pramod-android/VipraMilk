...
public class AdminRouteListAdapter extends RecyclerView.Adapter<AdminRouteListAdapter.RouteHolder> {
    ...
    public AdminRouteListAdapter(Context context) {
        mInflater = LayoutInflater.from(context);
    }

    @Override
    public RouteHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.recycler_admin_route_item, parent, false);
