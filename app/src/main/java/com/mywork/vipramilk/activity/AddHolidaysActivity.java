    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holidayData.setId(Integer.valueOf("" + selectedDates.get(0).get(Calendar.DAY_OF_MONTH) + selectedDates.get(0).get(Calendar.MONTH) + selectedDates.get(0).get(Calendar.YEAR)));
